...
public class EUsuario {
	...
	public String toString() {
		return "EUsuario [codigo=" + codigo + ", nombre=" + nombre + ", apellido=" + apellido + ", usuario=" + usuario
	...
	public EUsuario(int codigo, String nombre, String apellido, String usuario, String clave, String fnacim, int tipo,
			int estado) {
		super();
		this.codigo = codigo;
		this.nombre = nombre;
